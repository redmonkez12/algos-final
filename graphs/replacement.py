...
class TestChapter7(unittest.TestCase):
    ...
    def test_matrix_undirected_graph_weighted(self):
        ...
        G.add_edges_from(edge_list)
        self.assertEqual(
            sorted(edge_list + [('A2', 'A3', {'weight': 1}), ('A3', 'A4', {'weight': 2}), ('A4', 'A5', {'weight': 3})]),
            sorted(list(G.edges())))
        for i in range(2, 6):
            if 2 < i < 5:
        ...
        self.assertEqual(
            sorted([('C3', 'B3', {'weight': 2}), ('C3', 'C2', {'weight': 1}), ('C3', 'C4', {'weight': 1})]),
            sorted(list(G.edges('C3'))))
    ...
    def test_matrix_directed_graph_weighted(self):
        ...
        self.assertEqual(sorted(
            result_list + [('A2', 'A3', {'weight': 1}), ('A3', 'A4', {'weight': 2}), ('A4', 'A5', {'weight': 3})]),
                         sorted(list(DG.edges())))
        for i in range(2, 6):
            if 2 < i < 5:
        ...
        self.assertEqual(
            sorted([('B3', 'B4', {'weight': 4}), ('B3', 'B5', {'weight': 4}), ('B3', 'C3', {'weight': 4})]),
            sorted(list(DG.edges('B3'))))
